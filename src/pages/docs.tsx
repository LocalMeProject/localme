...
export function DocsPage() {
  useSeo({
    title: "LocalMe HTTP API reference — database, storage, auth, routing",
    description:
      "Every LocalMe endpoint in one place: the document database, file storage, shared library, visitor authentication, secrets and the reverse proxy, plus all status codes and platform limits.",
    path: "/docs",
    structuredData: {
      "@context": "https://schema.org",
      "@type": "TechArticle",
      headline: "LocalMe HTTP API reference",
      description:
        "Endpoint documentation for the LocalMe backend-as-a-service platform: database, storage, library, auth, secrets, proxy, routing, limits and errors.",
      inLanguage: "en",
    },
  });
        ...
        <div className="mx-auto flex h-14 max-w-6xl items-center justify-between px-4">
          ...
          <div className="flex items-center gap-2">
            <Button variant="ghost" size="sm" asChild>
              <a href={`${siteUrl}/health`} target="_blank" rel="noreferrer">
